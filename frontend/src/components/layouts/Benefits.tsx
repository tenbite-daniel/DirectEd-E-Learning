...
const Benefits: React.FC<BenefitsProps> = ({
    ...
    return (
        <section className="w-full flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-800 text-white text-center bg-cover bg-center bg-no-repeat">
            <h1 className="text-2xl md:text-4xl font-bold mb-4 text-black dark:text-white">
                {sectTitle}
            </h1>
            <h3 className="text-lg md:text-2xl text-black dark:text-white mb-6">
                {sectSubTitle}
            </h3>
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 mt-5 px-4 mx-auto">
